...
export function Education() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-1/3 left-0 w-56 h-56 bg-primary/5 rounded-full blur-3xl"
        animate={
          isInView
            ? {
                scale: [1, 1.3, 1],
      ...
      <motion.div
        className="absolute bottom-1/3 right-0 w-40 h-40 bg-secondary/5 rounded-full blur-3xl"
        animate={
          isInView
            ? {
                scale: [0.9, 1.2, 0.9],
